		...
		<div class="modal-dialog" role="document" style="width: 90%;">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" id="createClueBtn" class="close" data-dismiss="modal">
					...
					<tbody id="clueBody">
						<c:forEach items="${clueList}" var="clue">
							<tr>
								...
								<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='/workbench/clue/queryClueDetailInfo/${clue.id}';">${clue.fullname}</a></td>
								<td>${clue.company}</td>
								<td>${clue.phone}</td>
								<td>${clue.mphone}</td>
								<td>${clue.source}</td>
