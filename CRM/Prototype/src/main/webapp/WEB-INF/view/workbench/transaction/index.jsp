...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#createTransactionBtn").click(function () {
			window.location.href = "/workbench/transaction/createTransaction";
		})
				...
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <div class="form-group">
				    <div class="input-group">
					  ...
					  <select class="form-control">
					  	<option></option>
					  	<f:forEach items="${stageList}" var="stage">
				  ...
				  <div class="form-group">
				    <div class="input-group">
					  ...
					  <select class="form-control">
					  	<option></option>
					  	<c:forEach items="${tranStatusList}" var="transaction">
				...
				<table class="table table-hover">
					...
					<c:forEach items="${transactionList}" var="transaction">
						<tr>
							...
							<td><a style="text-decoration: none; cursor: pointer;" href="/workbench/transaction/queryDetailTransaction/${transaction.id}">${transaction.name}</a></td>
