...
<script type="text/javascript" src="/js/customer_opearation.js"></script>
					...
					<tbody id="customerBody">
						...
						<c:forEach items="${customerList}" var="customer" >
							<tr>
								...
								<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='detail.jsp';">${customer.name}</a></td>
