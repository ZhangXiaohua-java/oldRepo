 ...
 * @date 2022-7-19
 */
public final class ProcessParameter {
	...
	public  static  Map<String, Object> getParameter(String phone, String recordId, Integer money) throws UnsupportedEncodingException {
		map.clear();
		...
		//商户订单号，以下采用时间来定义订单号，商户可以根据自己订单号的定义规则来定义该值，不能为空。"KQ"+new java.text.SimpleDateFormat("yyyyMMddHHmmss").format(new java.util.Date())
		String orderId = DateUtils.getRecordId();
		//订单金额，金额以“分”为单位，商户测试以1分测试即可，切勿以大金额测试。该参数必填。
		String orderAmount = (money*100)+"";
